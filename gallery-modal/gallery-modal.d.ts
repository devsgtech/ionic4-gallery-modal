...
import { NavParams, Platform, IonSlides, ModalController } from '@ionic/angular';
...
export declare class GalleryModal implements OnInit {
    ...
    constructor(modalCtrl: ModalController, params: NavParams, element: ElementRef, platform: Platform, domSanitizer: DomSanitizer);
    ngOnInit(): void;
    /**
